...
function setupBundler(tree, options) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (options.bundler === 'webpack') {
            const { webpackProjectGenerator } = (0, devkit_1.ensurePackage)('@nrwl/webpack', versions_2.nxVersion);
...
function setDefaults(tree, options) {
    ...
    nxJson.generators['@nrwl/web:application'] = Object.assign({ style: options.style, linter: options.linter, unitTestRunner: options.unitTestRunner, e2eTestRunner: options.e2eTestRunner }, nxJson.generators['@nrwl/web:application']);
    nxJson.generators['@nrwl/web:library'] = Object.assign({ style: options.style, linter: options.linter, unitTestRunner: options.unitTestRunner }, nxJson.generators['@nrwl/web:library']);
...
function applicationGenerator(host, schema) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (options.bundler === 'vite') {
            const { viteConfigurationGenerator } = (0, devkit_1.ensurePackage)('@nrwl/vite', versions_2.nxVersion);
        ...
        if (options.bundler !== 'vite' && options.unitTestRunner === 'vitest') {
            const { vitestGenerator } = (0, devkit_1.ensurePackage)('@nrwl/vite', versions_2.nxVersion);
